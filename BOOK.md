...
This blog series consists of explaination of the authors note (description of the habits/principles) and highlight my opinion/observation of the principle with real time implementation for each part of the book.

All credits of the principles goes to the original Author of the book. My personal opinion/observation are exploratory nature and my personal notes.
...
<div style="text-align:center; margin: 20px 0;">
  <a href="BOOKS/7HBySRC/4" style="font-size:20px; font-weight:bold; text-decoration:none; padding:10px 20px;">
    Book Blog 1.4: 7 Habits By Stephen R Covey: Habit 2 - Begin with end in mind : Part 1
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
</div>
...
<div style="text-align:center; margin: 20px 0;">
  <a href="BOOKS/7HBySRC/7" style="font-size:20px; font-weight:bold; text-decoration:none; padding:10px 20px;">
    Book Blog 1.7: 7 Habits By Stephen R Covey: Emotional Deposit Bank Paradigm
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
</div>

<div style="text-align:center; margin: 20px 0;">
  <a href="BOOKS/7HBySRC/8" style="font-size:20px; font-weight:bold; text-decoration:none; padding:10px 20px;">
    Book Blog 1.8: 7 Habits By Stephen R Covey: Habit 4 - Win -Win Paradigm
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
</div>

<div style="text-align:center; margin: 20px 0;">
  <a href="BOOKS/7HBySRC/9" style="font-size:20px; font-weight:bold; text-decoration:none; padding:10px 20px;">
    Book Blog 1.9: 7 Habits By Stephen R Covey: Habit 5 - First seek to be understand then to be understood
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
</div>

<div style="text-align:center; margin: 20px 0;">
  <a href="BOOKS/7HBySRC/10" style="font-size:20px; font-weight:bold; text-decoration:none; padding:10px 20px;">
    Book Blog 1.10: 7 Habits By Stephen R Covey: Habit 6 - Synergy
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
</div>
...
<div style="text-align:center; margin: 20px 0;">
  <a href="BOOKS/7HBySRC/12" style="font-size:20px; font-weight:bold; text-decoration:none; padding:10px 20px;">
    Book Blog 1.12: 7 Habits By Stephen R Covey: Inside-out
  </a>
  &nbsp;&nbsp;&nbsp;&nbsp;
</div>
